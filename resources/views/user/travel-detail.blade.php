...
@section('title', 'Spirit Of Majapahit | Detail Travel')
              ...
              <div class="col-md-6 p-md-5 img img-2 mt-5 mt-md-0">
                ...
                <div class="col-md-6 wrap-about py-4 py-md-5 ftco-animate">
                    <div class="heading-section">
                        <div class="pl-md-5">
                            <h2>{{ $travel->nama_lokasi }}</h2>
                        </div>
                    </div>
                    <div class="pl-md-5">
                        <p>{{ $travel->ket_lokasi }}</p>
                    </div>
                    <div class="heading-section">
                        <div class="pl-md-5">
                            <p style="text-align: justify">{{ $travel->desc_lokasi }}</p>
                            <p><a href="{{ $travel->maps_lokasi }}" class="btn btn-primary btn-block" target="_blank">Link
                                    GMaps</a></p>
                        </div>
                    </div>
                </div>
