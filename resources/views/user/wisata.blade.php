...
@section('title', 'Spirit Of Majapahit | Wisata')
        ...
        <div class="container">
            <div class="row justify-content-center pb-5 mb-3">
                <div class="col-md-7 heading-section text-center ftco-animate">
                    <h1><strong>Info Wisata</strong></h1>
                    <span class="subheading" style="color: #ff8811;">Rekomendasi wisata yang dapat anda kunjungi</span>
                </div>
            </div>
