        ...
        <div class="container">
            ...
            <div class="row justify-content-center pb-5 mb-3">
                <div class="col-md-3 heading-section text-center ftco-animate">
                    @guest
                        <h2><a href="{{ route('login') }}" class="btn btn-warning btn-block">Tambah Ulasan</a></h2>
                    @else
                        <h2><a href="{{ route('ulasan', ['id' => $wisata->id_lokasi]) }}" class="btn btn-warning btn-block">Tambah Ulasan</a></h2>
                    @endguest
                </div>
            </div>
        </div>
