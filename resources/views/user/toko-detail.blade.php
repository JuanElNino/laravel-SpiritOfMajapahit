...
@section('title', 'Spirit Of Majapahit | Detail Toko Oleh - Oleh')
            ...
            <div class="row no-gutters">
              <div class="col-md-6 p-md-5 img img-2 mt-5 mt-md-0">
                ...
                <div class="col-md-6 wrap-about py-4 py-md-5 ftco-animate">
                    ...
                    <div class="heading-section">
                        <div class="pl-md-5">
                            <p style="text-align: justify">{{ $toko->desc_lokasi }}</p>
                            <p><a href="{{ $toko->maps_lokasi }}" class="btn btn-primary btn-block" target="_blank">Link
                                    GMaps</a></p>
                        </div>
                    </div>
                </div>
        ...
        <div class="container">
            ...
            <div class="row justify-content-center pb-5 mb-3">
                <div class="col-md-3 heading-section text-center ftco-animate">
                    ...
                    @else
                        <h2><a href="{{ route('ulasan', ['id' => $toko->id_lokasi]) }}" class="btn btn-success btn-block">Tambah Ulasan</a></h2>
                    @endguest
                </div>
            </div>
        </div>
